        ...
        <nav className="bg-white border-gray-200 shadow-md dark:bg-gray-900">
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                <div className="flex items-center">
                    ...
                    <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">MY Products</span>
                </div>
                ...
                <div className="relative mt-3 md:order-2 w-3/4 mx-auto sm:w-auto ">
